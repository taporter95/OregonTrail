...
$response = json_encode(array($_SESSION["party"], $_SESSION["stats"], $_SESSION["money"], 
...
$_SESSION["locale"], $_SESSION["milesTraveled"], $_SESSION["milesToNext"], $_SESSION["profession"], $_SESSION["disease"]));
