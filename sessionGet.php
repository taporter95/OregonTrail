...
$_SESSION["locale"], $_SESSION["milesTraveled"], $_SESSION["milesToNext"], $_SESSION["profession"], json_encode($_SESSION["disease"]), $_SESSION["partySize"], $_SESSION["monthVal"], $_SESSION["dayVal"], $_SESSION["yearVal"]));
